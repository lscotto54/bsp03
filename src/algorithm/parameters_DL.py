...
params = {
    ...
    # Class of problem
    'FITNESS_FUNCTION': "src.MNIST.MINST_ff",
    ...
    # Set grammar file
    'GRAMMAR_FILE': "src.MNIST.MNIST.pybnf",
...
def load_params(file_name):
    ...
    try:
        ...
        s = "algorithm.paremeters.load_params\n" \
            ...
            "       Ensure file extension is specified, e.g. 'cifar10_cnnc_full.txt'."
        raise Exception(s)
...
def set_params(command_line_args, create_files=True):
    ...
    from src.utilities.representation import grammar
